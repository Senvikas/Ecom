...
const HeroSection = () => {
    return (
        <section
            className="relative bg-cover bg-center h-[500px] w-screen -mx-4 p-0 m-0 -mt-4"
            style={{
        ...
        >
            ...
            {/* safe-secure           authentic            deliver same day */}
